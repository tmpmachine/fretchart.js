  ...
  function FretChart(instrument = 'guitar') {
    ...
    function drawNut(startFret) {
      if (startFret === 1) {
        ...
        ctx.fillRect(this.x - this.fretMargin, this.y - 2.3 * this.scale, (this.stringNumber - 1) * this.stringPadding + 2 * this.fretMargin, 4 * this.scale);
        ctx.shadowBlur = 0;
      }
    }
        ...
        if (instrument == 'guitar' && (c == ' ' || c == 'x' || c == '0')) {
          ...
          if (c >= fret) {
            ...
            if (barMode && f == whatBar && fonce === false) {
              ...
              ctx.font = 'bold ' + 10 * this.scale + 'px bold monospace';
              ...
              if (f !== undefined) {
                ...
                ctx.font = 'bold ' + fontSize * this.scale + 'px monospace';
